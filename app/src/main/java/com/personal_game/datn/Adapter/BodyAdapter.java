...
public class BodyAdapter extends RecyclerView.Adapter<BodyAdapter.ViewHolder>{
    private final List<Body> suggestList;
    private final Context context;
    private final SuggestListeners suggestListeners;

    public BodyAdapter(List<Body> suggestList, Context context, SuggestListeners suggestListeners){
    ...
    public interface SuggestListeners {
        void onClick(Body body, int position);
    }
}
